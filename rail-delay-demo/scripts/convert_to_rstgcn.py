...
def main(a):
    ...
    # ----- STOPS: tính sẵn timestamp & delay trên TOÀN BỘ rồi mới lọc -----
    ...
    # 1) Tính timestamp tốt nhất per-row (Series theo stops.index)
    def best_ts_row(i):
    ...
    # 2) Tính arr_delay/dep_delay cho TOÀN BỘ stops (Series theo stops.index)
    if arr_dly:
    ...
    # 3) Lập df CÙNG INDEX VỚI stops để align chuẩn
    ...
    # ----- train-frequency giữa ga kề nhau -----
