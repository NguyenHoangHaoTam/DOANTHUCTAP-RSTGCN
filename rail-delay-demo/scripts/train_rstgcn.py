# scripts/train_rstgcn.py
import argparse, os, json, random
import numpy as np
import torch
from torch.utils.data import DataLoader

# Lưu ý: nếu trước đó bạn import theo dạng khác, giữ theo môi trường bạn đang chạy
...
def main(a):
    ...
    X, A, D, F, meta = load_processed(a.data)   # X: (T,N,Fdim)
    T, N, Fdim = X.shape

    # steps per day = 1440 / slot_minutes
